...
module.exports = function(db) {
  db.serialize(function() {
    ...
    db.run("CREATE TABLE IF NOT EXISTS tasks ( id INTEGER PRIMARY KEY AUTOINCREMENT, parent_id INT, text VARCHAR(255), due_date DATE, difficulty INT, widget_id INT) ");
  });
}