...
module.exports = function(db) {
  db.serialize(function() {
    ...
    db.run("CREATE TABLE IF NOT EXISTS tasks ( id INTEGER PRIMARY KEY AUTOINCREMENT, parent_id INTEGER, text VARCHAR(255), due_date DATE, difficulty INTEGER, widget_id INTEGER) ");
  });
}